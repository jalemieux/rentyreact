...
/***/ function(module, exports, __webpack_require__) {
	...
	var Listings = __webpack_require__(221);
	var PropertyNew = __webpack_require__(222);
	var PropertyList = __webpack_require__(231);
	var PropertyDetails = __webpack_require__(236);
	var Applications = __webpack_require__(237);
	var Account = __webpack_require__(238);
	var Signout = __webpack_require__(239);

	var CashflowStatement = __webpack_require__(240);
	var Blank = __webpack_require__(243);
	var Affordability = __webpack_require__(244);
	...
	var routes = React.createElement(
	    ...
	    React.createElement(
	        Route,
	        { path: '/', component: Main },
	        React.createElement(IndexRoute, { component: CashflowStatement }),
	        React.createElement(Route, { path: '/cashflow', component: CashflowStatement }),
	        React.createElement(Route, { path: '/affordability', component: Affordability }),
	        React.createElement(Route, { path: '/messages', component: Messages }),
	        React.createElement(Route, { path: '/messages', component: Messages }),
	        React.createElement(Route, { path: '/properties', component: PropertyList }),
	        React.createElement(Route, { path: '/properties/new', component: PropertyNew }),
	        React.createElement(Route, { path: '/properties/:propertyId', component: PropertyDetails }),
	        React.createElement(Route, { path: '/listings', component: Listings }),
	        React.createElement(Route, { path: '/applications', component: Applications }),
	        React.createElement(Route, { path: '/messages', component: Messages }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavbarTools = __webpack_require__(219);
	...
	var Main = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(NavbarTools, null),
	      React.createElement(
	        'div',
	        { className: 'container' },
	        this.props.children,
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'a',
	            { className: 'navbar-brand', style: logo, href: '#' },
	            'Rentd'
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                Link,
	                { to: '/cashflow', activeClassName: 'active' },
	                'cashflow'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                Link,
	                { to: '/affordability', activeClassName: 'active' },
	                'affordability'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                Link,
	                { to: '/messages', activeClassName: 'active' },
	                'messages'
	              )
	            )
	          )
...
/***/ function(module, exports) {
	...
	// }
	// .property-shortcuts ul {
	//   margin-bottom: 0px;
	// }
	// .property-shortcuts li {
	//   cursor: pointer;
	// }

	// .prop-panel {
	//   background-color: rgba(255,255,255,0.75);
	//   -webkit-box-shadow: 1px 1px 1px 0px rgba(122,120,122,1);
	//   -moz-box-shadow: 1px 1px 1px 0px rgba(122,120,122,1);
	//   box-shadow: 1px 1px 1px 0px rgba(122,120,122,1);
	// }
	// .prop-panel-title {
	...
	// }
	// .prop-info-label {
	//   color: rgb(100,100,100); font-weight: inherit; font-size: inherit;
	// }
	// .prop-info {
	//   margin-bottom: 5px;
	// }
	// .prop-jumbo-img{
	//   opacity: 1;
	//   background-image: url('/images/95124.jpg');
	// }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Geosuggest = __webpack_require__(223);
	var Styles = __webpack_require__(220);
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control', id: 'city', value: this.state.locality, disabled: true })
	              )
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control', id: 'state', value: this.state.administrative_area_level_1, disabled: true })
	              )
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control', id: 'zip', value: this.state.postal_code, disabled: true })
	              )
	            )
	          ),
	          React.createElement(
	            'div',
	            { className: 'row form-inline', style: Styles.tinyTopMargin },
	            React.createElement(
	              'div',
	              { className: 'col-xs-4' },
	              React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control', id: 'beds', placeholder: '0' })
	              )
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control', id: 'baths', placeholder: '0' })
	              )
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control', id: 'sqft', placeholder: '0' })
	              )
	            )
	          ),
	          React.createElement(
	            'div',
	            { className: 'form-group', style: Styles.tinyTopMargin },
	            React.createElement(
	              'label',
	              { 'for': 'description' },
	              'Details'
	            ),
	            React.createElement('textarea', { name: 'description', id: 'inputDescription', className: 'form-control', rows: '3', required: 'required', placeholder: 'Describe your property to you prospective tenants. TODO Provide examples.' })
	          ),
	          React.createElement(
	            'div',
	            { className: 'form-group' },
	          ...
	          React.createElement(
	            ...
	            React.createElement('input', { type: 'file', name: 'pic', id: 'inputPic', 'class': 'form-control', value: '', required: 'required', title: '' })
	          ),
	          React.createElement(
	            'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filterInputAttributes = __webpack_require__(227);
	...
	var _suggestList = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _suggestItem = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Property = __webpack_require__(232);
	var PropertiesData = __webpack_require__(235);
	var Router = __webpack_require__(161);
	var Link = Router.Link;
	...
	var Properties = React.createClass({
	  ...
	  render: function () {
	    var properties = this.state.properties.map(function (propertyData) {
	      ...
	      return React.createElement(Property, { id: propertyData.propertyId, data: propertyData });
	    });
	    return React.createElement(
	      'div',
	      { className: 'row' },
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'p',
	              { className: 'lead' },
	              'See all your properties on a single page'
	            )
	          ),
	          React.createElement(
	            'div',
	            { className: 'col-lg-3 form-group', style: Styles.alignRight },
	            React.createElement(
	              'button',
	              { className: 'btn btn-default', onClick: this.newPropertyClick, type: 'submit' },
	              'Add A New Property'
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TenantsData = __webpack_require__(234);
	...
	var Property = React.createClass({
	  ...
	  render: function () {
	    ...
	    if (this.props.data.tenantId !== undefined) {
	      ...
	      tenantState = React.createElement(
	        'p',
	        null,
	        'Leased to ',
	        Utils.capitalizeFirstLetter(tenant.first),
	        ' ',
	        Utils.capitalizeFirstLetter(tenant.last)
	      );
	    }

	    return React.createElement(
	      'div',
	      { style: Styles.clickable, onClick: this.handlePropertyClick, className: 'panel panel-default' },
	      React.createElement(
	        'div',
	        { className: 'panel-body' },
	        React.createElement('img', { src: this.props.data.imgPath, style: Styles.propThumbnail }),
	        React.createElement(
	          'span',
	          { className: 'lead' },
	          React.createElement(
	        ...
	        React.createElement(
	          ...
	          this.props.data.sqft,
	          ' sqft | ',
	          this.props.data.beds,
	          ' beds | ',
	          this.props.data.baths,
	          ' baths'
	        ),
	        React.createElement(
	          'p',
	          null,
	          'vacancy: ',
	          this.props.data.vacancyStatus,
	          ' | listing status: ',
	          this.props.data.listingStatus
	        ),
	        React.createElement(
	          'p',
	          null,
	          'net monthly income: ',
	          this.props.data.incomeNet
	        ),
	        tenantState,
	        React.createElement(
	          'p',
	          ...
	          React.createElement(
	            Link,
	            { to: '/properties/' + this.props.data.propertyId },
	            'Details'
	          )
	        )
	      )
...
/***/ function(module, exports) {
	...
	var Tenants = [{
	  first: 'john',
	  last: 'doe',
	  tenantId: 'johndoe@anyone.com',
	  emailAddress: 'johndoe@anyone.com',
	  phoneNumber: '408 216 9672'
	}, {
	  first: 'jane',
	  last: 'doe',
	  tenantId: 'janedoe@anyone.com',
	  emailAddress: 'janedoe@anyone.com',
	  phoneNumber: '408 216 9672'
	}];
...
/***/ function(module, exports) {
	...
	var PropertiesData = [{
	  "propertyId": 1,
	  address1: "3933 paladin dr",
	  address2: "San Jose CA",
	  "description": "Lorem ipsum Officia sed quis irure in veniam.",
	  "sqft": 1120,
	  "beds": 3,
	  "baths": 2,
	  "vacancyStatus": 'vacant',
	  "listingStatus": 'listed',
	  "imgPath": '/images/95124.jpg',
	  "incomeGross": 1234,
	  "expensesGross": 432,
	  "incomeNet": 123
	}, {
	  "propertyId": 2,
	  address1: "107 El camino Real #305",
	  address2: "Burlingame CA",
	  "description": "Lorem ipsum Officia sed quis irure in veniam.",
	  "sqft": 1120,
	  "beds": 3,
	  "baths": 2,
	  "vacancyStatus": 'leased',
	  "listingStatus": 'n/a',
	  "imgPath": '/images/95124.jpg',
	  "incomeGross": 1234,
	  "expensesGross": 432,
	...
	var PropertyDetail = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'row' },
	      React.createElement('div', { style: Styles.propJumboImgStyle }),
	      React.createElement(
	        'div',
	        { className: 'col-xs-12 col-sm-12 col-md-10 col-lg-8 ', style: Styles.propPanel },
	        React.createElement(
	          'div',
	          { style: Styles.propAddress },
	          React.createElement(
	            'div',
	            { style: Styles.propAddress1 },
	            prop.address1
	          ),
	          React.createElement(
	            'div',
	            { style: Styles.propAddress2 },
	            prop.address2
	          ),
	          React.createElement(
	            'div',
	            { style: Styles.propInfo },
	            React.createElement(
	              'div',
	              { style: Styles.propInfoBlockLeft },
	              React.createElement(
	                'span',
	                { style: Styles.propInfoLabel },
	                React.createElement(
	                  'small',
	                  null,
	                  'Vacancy'
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement('span', { className: 'glyphicon glyphicon-pencil glyphicon-mini', 'aria-hidden': 'true' })
	            )
	          ),
	          React.createElement(
	            'div',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'panel-body' },
	            React.createElement('img', { src: '/images/95124.jpg', alt: '...', style: Styles.propThumb, className: 'img-thumbnail' }),
	            React.createElement('img', { src: '/images/95124.jpg', alt: '...', style: Styles.propThumb, className: 'img-thumbnail' }),
	            React.createElement('img', { src: '/images/burlingame.jpg', alt: '...', style: Styles.propThumb, className: 'img-thumbnail' }),
	            React.createElement('img', { src: '/images/95124.jpg', alt: '...', style: Styles.propThumb, className: 'img-thumbnail' })
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            'Display picture and name of tenant',
	            React.createElement('br', null),
	            'Display any new message notification',
	            React.createElement('br', null),
	            'Display current state of rent if rent is tracked',
	            React.createElement('br', null)
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement('br', null),
	            'If listed, display landing page hits (if possible)',
	            React.createElement('br', null),
	            'Display number of leads',
	            React.createElement('br', null),
	            'Display any upcoming open house',
	            React.createElement('br', null),
	            'Display any new message notification',
	            React.createElement('br', null)
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var numeral = __webpack_require__(241);
	var amortize = __webpack_require__(242);

	var RentalPassiveIncome = React.createClass({
	  displayName: 'RentalPassiveIncome',
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement('input', { type: 'number', min: '0', inputMode: 'numeric', pattern: '[0-9]*', onChange: this.handlePurchasePriceChange, className: 'form-control', id: 'purchasePrice', placeholder: 'Purchase Price', value: this.state.purchasePrice })
	                      )
	                    ),
	                    React.createElement(
	                      'div',
	                      ...
	                      React.createElement(
	                        'div',
	                        { className: 'input-group' },
	                        React.createElement('input', { type: 'number', min: '0', inputMode: 'numeric', pattern: '[0-9]*', onChange: this.handleInterestRateChange, className: 'form-control', id: 'interestRate', placeholder: 'Interest Rate', value: this.state.interestRate }),
	                        React.createElement(
	                          'div',
	                          { className: 'input-group-addon' },
	                          '%'
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        'label',
	                        { htmlFor: 'monthlyRent', className: 'control-label' },
	                        'Monthly Rent'
	                      ),
	                      React.createElement(
	                        'div',
	                        ...
	                        React.createElement('input', { type: 'number', min: '0', inputMode: 'numeric', pattern: '[0-9]*', onChange: this.handleMonthlyRentChange, className: 'form-control', id: 'monthlyRent', placeholder: 'Monthly Rent', value: this.state.monthlyRent })
	                      )
	                    ),
	                    React.createElement(
	                      'button',
	                      { type: 'button', onClick: this.handleCalc, className: 'col-sm-offset-2 btn btn-primary' },
	                      'calculate!'
	                    )
	                  )
	                )
	  ...
	  render: function () {
	    ...
	    if (this.state.cashBeforeReserve != '') {
	      if (this.state.cashBeforeReserve < 0) {
	        cashReqMet = React.createElement(
	          'div',
	    ...
	    if (this.state.cashAfterReserve != '') {
	      if (this.state.cashAfterReserve < 0) {
	        reserveReqMet = React.createElement(
	          'div',
	          { className: 'alert alert-danger alert-dismissible', role: 'alert' },
	          'You are not meeting the reserve requirement.'
	        );
	      } else {
	        reserveReqMet = React.createElement(
	          'div',
	          { className: 'alert alert-success alert-dismissible', role: 'alert' },
	          'You meet the reserve requirement!'
	        );
	      }
	    }
	    ...
	    if (this.state.debtRatio != '') {
	      if (this.state.debtRatio > 43) {
	        debtRationReqMet = React.createElement(
	          'div',
	          { className: 'alert alert-danger alert-dismissible', role: 'alert' },
	          'You are not meeting the debt ratio requirement.'
	        );
	      } else {
	        debtRationReqMet = React.createElement(
	          'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      'label',
	                      { htmlFor: 'rehabAmount', className: 'control-label' },
	                      'Rehab Amount'
	                    ),
	                    React.createElement(
	                      'div',
	                      ...
	                      React.createElement('input', { type: 'number', min: '0', inputMode: 'numeric', pattern: '[0-9]*', onChange: this.rehabAmountChange, className: 'form-control', id: 'rehabAmount', placeholder: '30,000', value: this.state.rehabAmount })
	                    )
	                  ),
	                  React.createElement('hr', null),
	                  React.createElement(
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      'label',
	                      { htmlFor: 'cashDownRate', className: 'control-label' },
	                      'Cash Down Rate'
	                    ),
	                    React.createElement(
	                      'div',
	                      { className: 'input-group' },
	                      React.createElement('input', { type: 'number', min: '0', inputMode: 'numeric', pattern: '[0-9]*', onChange: this.cashDownRateChange, className: 'form-control', id: 'cashDownRate', placeholder: '25', value: this.state.cashDownRate }),
	                      React.createElement(
	                        'div',
	                        { className: 'input-group-addon' },
	                        '%'
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      'div',
	                      { className: 'input-group' },
	                      React.createElement('input', { type: 'number', inputMode: 'numeric', onChange: this.interestRateChange, className: 'form-control', id: 'interestRate', placeholder: '4', value: this.state.interestRate }),
	                      React.createElement(
	                        'div',
	                        { className: 'input-group-addon' },
	                        '%'
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement('input', { type: 'number', min: '0', inputMode: 'numeric', pattern: '[0-9]*', onChange: this.cashInBankChange, className: 'form-control', id: 'cashInBank', value: this.state.cashInBank })
	                    )
	                  ),
	                  React.createElement(
	                    'button',
	                    { type: 'button', onClick: this.handleCalculate, className: 'pull-right btn btn-primary' },
	                    'Calculate'
	                  )
	                )
	              )
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'th',
	                          null,
	                          numeral(this.state.cashInBank).format('($0,0.00)')
	                        )
	                      )
	                    ),
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.cashDownCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.rehabCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.cashBeforeReserve).format('($0,0.00)')
	                        )
	                      )
	                    )
	                  ),
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.reserverRequirementCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.cashAfterReserve).format('($0,0.00)')
	                        )
	                      )
	                    )
	                  ),
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'th',
	                          null,
	                          numeral(this.state.monthlyPretaxIncome).format('($0,0.00)')
	                        )
	                      )
	                    ),
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyDebtsPaymentsCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyPIITCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.debtRatio).format('(%0.0)')
	                        )
	                      )
	                    )
	                  ),
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyInterestCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyTaxesCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyInsuranceCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyPrincipalCost).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyTaxSaving).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.monthlyCostAfterTax).format('($0,0.00)')
	                        )
	                      )
	                    )
	                  )
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          'td',
	                          null,
	                          numeral(this.state.loanAmount).format('($0,0.00)')
	                        )
	                      ),
	                      React.createElement(
	                        'tr',
	                      ...
	                      React.createElement(
	                        ...
	                        React.createElement(
	                          ...
	                          React.createElement(
	                            'strong',
	                            null,
	                            numeral(this.state.totalLoanPaid).format('($0,0.00)')
	                          )
	                        )
	                      )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./renty.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./renty.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".prop-thumbnail{\n  float: left;\n  max-width: 150px;\n  margin: 0px 15px 10px 0px;\n}\n\n.omg-yellow {\n  background-color: yellow;\n}\n\n\n.prop-tile-small{\n  padding-bottom: 10px;\n  margin-top: 0;\n  margin-bottom: 20px;\n  margin-right: 40px;\n  background: #FFF;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  border-left: 1px solid #efefef;\n  border-right: 1px solid #efefef;\n  border-bottom: 1px solid #e2e2e2;\n  box-shadow: 0 1px 0 0 rgba(0, 0, 0, 0.04);\n  cursor: pointer;\n}\n\n.prop-jumbo-img{\n  background-color: rgb(238, 238, 238);\n  box-sizing: border-box;\n  color: rgb(51, 51, 51);\n  display: block;\n  font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;\n  font-size: 14px;\n  height: 600px;\n  line-height: 20px;\n  margin-bottom: 30px;\n  padding-bottom: 48px;\n  padding-top: 48px;\n  width: 100%;\n  background-size:     cover;                    \n  background-repeat:   no-repeat;\n  background-position: center center;    \n  position: fixed;\n  top: 0;\n  left: 0;   \n  z-index: -100;\n}\n\n\n\n.property-view-title{\n    opacity: 1;\n    color: rgb(0,0,0);\n}\n\n/* nav bar */\n.avatar-nav {\n  max-height:30px;\n  margin-right: 10px;\n}\n\n\n/* property page */ \nbody {\n  font-family: 'Open Sans', sans-serif;\n}\n.property-shortcuts {\n  border-bottom: 1px solid rgb(150,150,150);\n}\n.property-shortcuts ul {\n  margin-bottom: 0px;\n}\n.property-shortcuts li {\n  cursor: pointer;\n}\n\n.prop-panel {\n  background-color: rgba(255,255,255,0.75);\n  -webkit-box-shadow: 1px 1px 1px 0px rgba(122,120,122,1);\n  -moz-box-shadow: 1px 1px 1px 0px rgba(122,120,122,1);\n  box-shadow: 1px 1px 1px 0px rgba(122,120,122,1);\n}\n.prop-panel-title {\n  border-bottom: 1px rgb(150,150,150) solid;\n  background-color: rgb(255,255,255);\n}\n\n.glyphicon-mini {\n  font-size: 12px;\n}\n\n.prop-thumb{\n  max-width: 125px;\n}\n\n.prop-address {\n  margin: 30px 0px 20px 0px; \n  padding: 0px;\n  text-align: center;\n\n}\n.prop-address-1 {\n  font-weight: 600;\n  text-align: center; \n  font-size: 30px;  \n  line-height: 28px; \n}\n.prop-address-2 {\n  font-weight: 400; \n  color: rgb(100,100,100);\n  font-size: 24px; \n}\n.prop-info-block{\n  display: inline-block; \n  padding: 0px 13px 0px 13px; \n  text-align: center; \n  border-left: 1px solid rgb(100,100,100);\n}\n.prop-info-block-left {\n  display: inline-block; \n  padding: 0px 13px 0px 13px; \n  text-align: center; \n}\n.prop-info-value {\n  font-weight: 600; font-size: 16px;\n}\n.prop-info-label {\n  color: rgb(100,100,100); font-weight: inherit; font-size: inherit;\n}\n.prop-info {\n  margin-bottom: 5px;\n}\n.prop-jumbo-img{\n  opacity: 1;\n  background-image: url('/images/95124.jpg');\n}\n\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Messages = React.createClass({
	  ...
	  getInitialState: function () {
	    return {
	      messages: [{ text: "hi there" }, { text: "hola" }, { text: "bonjour!" }]
	    };
	  },
	  render: function () {
